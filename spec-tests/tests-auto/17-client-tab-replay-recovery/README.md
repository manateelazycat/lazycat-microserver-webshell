...
规格：[REQ](../../../spec/webshell/17-client-tab-replay-recovery/REQ.md) · [AC](../../../spec/webshell/17-client-tab-replay-recovery/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/17-client-tab-replay-recovery`（产品根目录）。
