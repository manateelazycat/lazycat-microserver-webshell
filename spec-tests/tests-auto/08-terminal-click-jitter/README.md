...
规格：[REQ](../../../spec/webshell/08-terminal-click-jitter/REQ.md) · [AC](../../../spec/webshell/08-terminal-click-jitter/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/08-terminal-click-jitter`（产品根目录）。
