...
规格：[REQ](../../../spec/webshell/11-service-worker-retirement/REQ.md) · [AC](../../../spec/webshell/11-service-worker-retirement/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/11-service-worker-retirement`（产品根目录）。
