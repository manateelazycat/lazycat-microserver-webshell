...
规格：[REQ](../../../spec/webshell/01-multi-device-resize-sync/REQ.md) · [AC](../../../spec/webshell/01-multi-device-resize-sync/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/01-multi-device-resize-sync`（产品根目录）。
