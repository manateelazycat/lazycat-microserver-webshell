...
规格：[REQ](../../../spec/webshell/03-terminal-ime/REQ.md) · [AC](../../../spec/webshell/03-terminal-ime/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/03-terminal-ime`（产品根目录）。
