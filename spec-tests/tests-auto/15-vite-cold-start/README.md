...
规格：[REQ](../../../spec/webshell/15-vite-cold-start/REQ.md) · [AC](../../../spec/webshell/15-vite-cold-start/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/15-vite-cold-start`（产品根目录）。
