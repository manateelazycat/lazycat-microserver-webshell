...
规格：[REQ](../../../spec/webshell/07-workspace-retry/REQ.md) · [AC](../../../spec/webshell/07-workspace-retry/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/07-workspace-retry`（产品根目录）。
