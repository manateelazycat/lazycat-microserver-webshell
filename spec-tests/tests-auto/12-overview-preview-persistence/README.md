...
规格：[REQ](../../../spec/webshell/12-overview-preview-persistence/REQ.md) · [AC](../../../spec/webshell/12-overview-preview-persistence/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/12-overview-preview-persistence`（产品根目录）。
