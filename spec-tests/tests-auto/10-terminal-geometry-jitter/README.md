...
规格：[REQ](../../../spec/webshell/10-terminal-geometry-jitter/REQ.md) · [AC](../../../spec/webshell/10-terminal-geometry-jitter/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/10-terminal-geometry-jitter`（产品根目录）。
