...
规格：[REQ](../../../spec/webshell/06-workspace-tabs/REQ.md) · [AC](../../../spec/webshell/06-workspace-tabs/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/06-workspace-tabs`（产品根目录）。
