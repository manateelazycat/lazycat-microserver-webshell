...
规格：[REQ](../../../spec/webshell/02-terminal-input/REQ.md) · [AC](../../../spec/webshell/02-terminal-input/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/02-terminal-input`（产品根目录）。
