...
规格：[REQ](../../../spec/webshell/09-terminal-interaction-jitter/REQ.md) · [AC](../../../spec/webshell/09-terminal-interaction-jitter/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/09-terminal-interaction-jitter`（产品根目录）。
