...
规格：[REQ](../../../spec/webshell/04-terminal-viewport/REQ.md) · [AC](../../../spec/webshell/04-terminal-viewport/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/04-terminal-viewport`（产品根目录）。
