...
规格：[REQ](../../../spec/webshell/14-terminal-input-lock-lifecycle/REQ.md) · [AC](../../../spec/webshell/14-terminal-input-lock-lifecycle/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/14-terminal-input-lock-lifecycle`（产品根目录）。
