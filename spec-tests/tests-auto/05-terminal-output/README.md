...
规格：[REQ](../../../spec/webshell/05-terminal-output/REQ.md) · [AC](../../../spec/webshell/05-terminal-output/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/05-terminal-output`（产品根目录）。
