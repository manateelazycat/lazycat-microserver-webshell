...
规格：[REQ](../../../spec/webshell/13-split-divider-render-isolation/REQ.md) · [AC](../../../spec/webshell/13-split-divider-render-isolation/AC.md)。环境与目标：[ENVIRONMENT](../../ENVIRONMENT.md)。
单模块：`./run-ac.sh --selector webshell/13-split-divider-render-isolation`（产品根目录）。
