...
import { redactBrowserArtifacts, redactDiagnosticText } from "../tests-auto/artifact-redaction.mjs";
...
const artifactsDir = path.resolve(options.artifactsDir || path.join(projectRoot, "artifacts", randomUUID()));
